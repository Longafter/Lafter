...
class Comment(models.Model):
    ...
    parent = models.ForeignKey('self', on_delete=models.CASCADE, verbose_name='父评论', related_name='%(class)s_child_comments', blank=True,
                               null=True)
    rep_to = models.ForeignKey('self', on_delete=models.CASCADE, verbose_name='回复', related_name='%(class)s_rep_comments', blank=True, null=True)
